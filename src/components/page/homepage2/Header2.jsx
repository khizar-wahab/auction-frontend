    ...
    <div className={search === 1 ? "mobile-search slide" : "mobile-search"}>
        <div className="container">
          <div className="row d-flex justify-content-center">
            ...
            <div className="col-1 d-flex justify-content-end align-items-center">
              <div className="search-cross-btn style-2" onClick={searchFullScreen} >
     ...
     <header className="header-area style-2">
        <div className="header-logo">
            <Link to={"#"}><img alt="imagelogo" onClick={scrollTop} src={ "/images/bg/header-logo2.png"}/> </Link>
        </div>
        ...
        <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
          <div className="mobile-logo-wrap ">
            <Link to={"/"}>
              <img
                alt="logo"
                src={"/images/bg/header-logo2.png"}
              />
            </Link>
          </div>
        ...
        <div className="nav-right d-flex align-items-center">
            ...
            <Link to={`/join-merchant`} onClick={scrollTop}className="join-btn">Join Merchant</Link>
            <div className="eg-btn btn--primary2 header-btn">
                <Link to={`/login`} onClick={scrollTop}>My Account</Link>
            </div>
